...
*/
/*
LAB ASSIGNMENT 4: Construct an expression tree from the given prefix expression 
...
void tree::non_rec_postorder(node *top) {
    stack1 s1, s2;
    /* stack s1 is being used for flag. A NULL data implies that the right subtree has not been visited */
    node *T = top;
