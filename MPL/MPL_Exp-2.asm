...
dec  al                ; Decrement al to compensate for trailing null 
character 
...
jbe  copydigit         ; Jump to label 'next1' if result of cmp was 
below or equal 
add  dl  , 07h         ; Add 07h if greater than 09h

copydigit: 
add  dl  , 30h         ; Add 30h always 
mov  [rsi]  ,  dl      ; copy byte from dl to location specified by 
rsi 
